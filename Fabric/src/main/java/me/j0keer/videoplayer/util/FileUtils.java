...
import me.j0keer.videoplayer.config.Configuration;
import me.j0keer.videoplayer.config.ConfigurationProvider;
import me.j0keer.videoplayer.config.YamlConfiguration;
...
public class FileUtils {
    ...
    public FileUtils(VideoPlayer mod, String path, String fileName) {
        file = new File(mod.getDataFolder() + path, fileName);
        init();
    }

    public FileUtils(VideoPlayer mod, String fileName) {
